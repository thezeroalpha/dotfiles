 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'jokull
	...
	`(cursor ((,class (:background ,fg2 :foreground ,bg2))))
        ...
        `(which-func ((,class (:foreground "#e5e5e5" :inherit mode-line :slant italic))))
	...
	`(org-hide ((,class (:foreground ,bg1))))
        ...
        `(org-block ((,class (:background "#ececec"))))
        `(org-block-begin-line ((,class (:background ,bg1 :slant italic))))
        ...
        `(org-agenda-date ((,class (:foreground ,var :height 1.2))))
        `(org-agenda-calendar-event ((,class (:foreground ,func))))
  ...
  (when (>= emacs-major-version 26)
    (custom-theme-set-faces
     'jokull
     `(line-number ((t (:inherit fringe :foreground ,olive))))
     `(line-number-current-line ((t (:inherit fringe :foreground ,const :weight bold))))))
  ;; emacs >= 27.1
  (when (>= emacs-major-version 27)
    (custom-theme-set-faces
     'jokull
     `(line-number ((t (:background ,bg1 :foreground ,olive))))
     `(line-number-current-line ((t (:background ,bg2 :foreground ,const))))
...
(provide-theme 'jokull)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; jokull-theme.el ends here
